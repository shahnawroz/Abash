...
<?php
    ...
    $sql="SELECT * FROM regi WHERE (tag='1' AND( un='$un' OR email='$email'));";
   ...
   else
   {
	...
	mysqli_query($connection,"INSERT INTO regi(tag,name, email,un,address, phone_no,pw) VALUES ('1','$name', '$email','$un','$adr','$phn', '$pass')")
...
<div class="reg">
	<form name="myForm" onsubmit="return validateForm()" method="POST" action="">
			...
			<input type="submit" value="Add" name="submit" class="btn sbtn">
